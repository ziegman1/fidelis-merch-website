  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-serif text-3xl text-brand-primary tracking-wide">Products</h1>
            ...
            {products.length === 0 ? (
              <TableRow className="border-zinc-700">
                <TableCell colSpan={6} className="text-center text-zinc-500 py-8">
                  No products yet. <Link href="/admin/products/new" className="text-brand-primary hover:underline">Add one</Link>.
                </TableCell>
              </TableRow>
            ) : (
              products.map((p) => (
                <TableRow key={p.id} className="border-zinc-700 hover:bg-zinc-800/50">
                  ...
                  <TableCell>
                    <Badge variant={p.fulfillmentType === "dropship" ? "secondary" : "outline"} className="border-brand-primary/50">
                      {p.fulfillmentType}
                    </Badge>
                  </TableCell>
                  ...
                  <TableCell className="text-right">
                    <Button asChild variant="ghost" size="sm" className="text-brand-primary">
