...
export default function AdminSettingsPage() {
  return (
    <div className="space-y-8">
      <h1 className="font-serif text-3xl text-brand-primary tracking-wide">Settings</h1>
      ...
      <Card className="border-brand-primary/25 bg-zinc-900 max-w-2xl">
        ...
        <CardContent>
          <p className="text-sm text-zinc-500">
            ...
            For now, branding is applied via the design system in <code className="text-brand-primary">/docs/branding.md</code>.
          </p>
        </CardContent>
      </Card>
    </div>
